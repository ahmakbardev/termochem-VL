...
@section('content')
    <div class="relative w-screen">
        <div class="flex gap-5 absolute top-0 left-5 w-60 h-60">
        ...
        <div class="flex gap-5 absolute top-0x right-[3.25rem] w-[235px] h-60">
            <img src="{{ asset('assets/icons/right-1.png') }}" class="w-fit object-contain max-w-36 z-[2] h-fit"
                alt="">
            <img src="{{ asset('assets/icons/right-2.png') }}" class="w-fit object-contain max-w-24 z-[2] h-fit"
                alt="">
        </div>
            ...
            <div class="flex flex-col lg:flex-row lg:space-x-8">
                ...
                <aside class="lg:w-1/4 hidden lg:block">
                    <nav class="space-y-4 sticky top-28">
                        ...
                        <a href="#energi-dan-perubahan-energi"
                        ...
                        <a href="#penentuan-perubahan-entalpi"
                            class="block px-4 py-2 bg-gray-100 rounded-md hover:bg-gray-200">
                        ...
                        <a href="#berdasarkan-energi-ikatan"
                            class="block px-4 py-2 bg-gray-100 rounded-md hover:bg-gray-200">
                ...
                <main class="lg:w-3/4">
                    <section id="konsep-dasar-termokimia" class="mb-12">
                        ...
                        <article class="prose lg:prose-lg max-w-none">
                            <p>Energi dalam termokimia sangat berkaitan dengan berbagai aspek kehidupan sehari-hari kita.
                                Proses
                                pembakaran, seperti saat menggunakan bahan bakar LPG untuk memasak, merupakan contoh nyata
                                di
                                mana energi kimia dalam molekul bahan bakar diubah menjadi energi panas dan cahaya. Reaksi
                                kimia
                            ...
                            <p>Namun, tidak semua reaksi kimia menghasilkan energi. Termokimia adalah cabang ilmu kimia yang
                                mempelajari energi panas yang terlibat dalam reaksi kimia, termasuk jumlah energi yang
                                diserap
                    ...
                    <section id="perubahan-kalor-reaksi-kimia" class="mb-12">
                        <header class="mb-6">
                            <h3
                                class="text-xl font-bold text-white bg-orange-500 inline-block px-4 py-2 rounded-md shadow-md">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mt-6">
                            <div class="bg-blue-100 p-4 rounded-md flex flex-col justify-between">
                                <p>Ketika secangkir teh panas didiamkan di atas meja, suhu teh perlahan-lahan turun seiring
                                    ...
                                    kehidupan sehari-hari. Perubahan kalor adalah peristiwa di mana energi panas berpindah
                                    dari
                                ...
                                <figure class="mt-4">
                                    ...
                                    <figcaption class="text-sm text-center text-gray-600 mt-2">Gambar 1. Teh Panas
                                    </figcaption>
                                </figure>
                            </div>

                            <div class="bg-blue-100 p-4 rounded-md flex flex-col justify-between">
                                <p>Pada malam hari saat cuaca dingin, sekelompok siswa sedang berkemah. Mereka menyalakan
                                    api
                                    unggun menggunakan kayu bakar. Ketika api mulai menyala, mereka duduk melingkar di
                                    sekitarnya.</p>
                                <p><strong>Mengapa</strong> kita merasa hangat saat berada di dekat api unggun, meskipun
                                    tidak
                                    menyentuh apinya?</p>
                                <figure class="mt-4">
                                    <img src="{{ asset('assets/images/materi/api-unggun.png') }}" alt="Api Unggun"
                                        class="w-full rounded-md shadow-md">
                                    <figcaption class="text-sm text-center text-gray-600 mt-2">Gambar 2. Api Unggun
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                    ...
                    <section id="sistem-dan-lingkungan" class="mb-12">
                        ...
                        <article class="prose lg:prose-lg max-w-none">
                            <p>Sistem adalah bagian tertentu dari alam yang menjadi pusat perhatian sedangkan lingkungan
                                adalah
                                segala sesuatu yang berada di luar sistem. Sistem dan lingkungan dapat mengalami suatu
                                interaksi
                                berupa perpindahan kalor.</p>

                            <p>Berdasarkan interaksi antara sistem dan lingkungan, sistem dibedakan menjadi tiga jenis,
                                yaitu
                                sistem terbuka, sistem tertutup, dan terisolasi. Untuk memahami jenis-jenis sistem lebih
                                lanjut,
                            ...
                            <div class="flex justify-center my-6">
                                <figure class="w-full md:w-2/3">
                                    <img src="{{ asset('assets/images/materi/sistem.png') }}" alt="Jenis Sistem Termokimia"
                                        class="w-full rounded-md shadow-md">
                                    <figcaption class="text-sm text-center text-gray-500 mt-2">A. Sistem terbuka
                                        &nbsp;&nbsp; B.
                            ...
                            <ol class="list-decimal ml-6">
                                <li>Sistem terbuka, suatu sistem yang memungkinkan terjadinya pertukaran kalor dan zat
                                    (materi)
                                    antara lingkungan dan sistem.</li>
                                <li>Sistem tertutup, suatu sistem yang memungkinkan terjadinya pertukaran kalor antara
                                    sistem
                        ...
                        <aside class="bg-blue-100 p-4 rounded-md mt-6 shadow-md">
                            ...
                            <p>Ketika teko berisi air diletakkan di atas kompor dan dipanaskan, beberapa perubahan terjadi
                                yang
                    ...
                    <section id="energi-dan-perubahan-energi" class="mb-12">
                        ...
                        <article class="prose lg:prose-lg max-w-none">
                            <p>Seperti penjelasan sebelumnya, energi dapat mengalami perubahan. Begitu pula energi yang
                                terlibat
                                dalam suatu sistem. Setiap materi mengandung energi yang disebut energi dalam. Energi dalam
                                merupakan total energi yang dimiliki oleh suatu benda. Besarnya energi ini tidak dapat
                                diukur,
                            ...
                            <p>Dalam termodinamika, perubahan energi dalam adalah kombinasi dari kalor yang ditransfer dan
                                kerja
                                yang dilakukan. Sehingga secara matematis rumus energi dalam dapat dituliskan sebagai
                                berikut:
                            </p>
                        ...
                        <div class="bg-blue-50 p-4 rounded-md mt-6 shadow-md">
                            ...
                            <ol class="list-decimal ml-6">
                                <li>Suatu sistem menyerap kalor sebesar 300 kJ setelah melakukan kerja sebesar 125 kJ.
                                    Tentukan
                                    perubahan energi yang terjadi!</li>
                                <li>Kerja sebesar 70 J diberikan pada suatu gas. Hasilnya gas tersebut dapat memanfaatkan
                                    dengan
                        ...
                        <article class="prose lg:prose-lg max-w-none mt-12">
                            ...
                            <p>Pada termodinamika, total energi dalam (E) dikenal dengan istilah <strong>Entalpi
                                    (H)</strong>,
                                yaitu jumlah total energi dari suatu sistem yang diukur pada kondisi tekanan tetap. Sama
                                dengan
                                energi dalam, entalpi tidak dapat diukur secara langsung, yang dapat ditentukan adalah
                                perubahan
                    ...
                    <section id="reaksi-kimia" class="mt-20 space-y-12">
                        ...
                        <div>
                            ...
                            <ol class="mt-2 space-y-2 list-decimal pl-4 text-gray-700">
                                <li>
                                    <strong>Reaksi Eksoterm</strong> yaitu apabila kalor berpindah dari sistem ke
                                    lingkungan,
                                    artinya sistem melepaskan kalor. Hal ini akan meningkatkan suhu lingkungan.
                                </li>
                                <li>
                                    <strong>Reaksi Endoterm</strong> yaitu apabila kalor berpindah dari lingkungan ke
                                    sistem,
                        ...
                        <div>
                            ...
                            <div class="mt-4 bg-blue-50 p-4 rounded-md text-gray-700">
                                <p>Ketika bahan bakar (seperti kayu) dibakar, terjadi reaksi kimia yang melepaskan energi
                                    dalam
                                    bentuk panas dan cahaya. Misalnya, saat kayu dibakar dalam perapian, panas yang
                                    dihasilkan
                                    membuat lingkungan sekitar terasa hangat.</p>
                                <h4 class="font-bold mt-3">Mengapa pembakaran dianggap sebagai reaksi eksoterm?</h4>
                                <p><strong>Pembahasan:</strong> Pembakaran kayu dianggap sebagai reaksi eksoterm karena
                                    selama
                        ...
                        <div class="mt-8">
                            ...
                            <div class="mt-4 bg-blue-50 p-4 rounded-md text-gray-700">
                                <p>Pada tanaman, proses fotosintesis melibatkan penyerapan energi matahari untuk mengubah
                                    karbon
                                ...
                                <p>Tanaman menyerap cahaya melalui klorofil di daun untuk memicu reaksi kimia dalam
                                    kloroplas.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            <ol class="list-decimal pl-4 text-gray-700 space-y-3 mt-3">
                                <li>
                                    Bila entalpi produk &gt; entalpi reaktan, maka <strong>ΔH positif</strong>, artinya
                                    reaksi
                                    endoterm. Contoh:
                                    <p class="font-mono bg-white p-2 rounded mt-1">energi + 2HgO(s) → 2Hg(l) +
                                        O<sub>2</sub>(g)
                                    </p>
                                </li>
                                <li>
                                    Bila entalpi reaktan &gt; entalpi produk, maka <strong>ΔH negatif</strong>, artinya
                                    reaksi
                                    eksoterm. Contoh:
                            ...
                            <p class="text-center mt-2 text-sm italic">Gambar 5. Diagram Reaksi Eksoterm dan Reaksi
                                Endoterm
                            </p>
                        </div>
                    </section>
                  ...
                  CH₄(g) + 2O₂(g) → CO₂(g) + 2H₂O(l)      ΔH = –890,4 kJ/mol
                            ...
                            <div class="bg-blue-50 p-4 rounded mb-6">
                                ...
                                <p class="mb-4">Penguraian 1 mol kloroform (CH₃Cl) melepaskan kalor 80,84 kJ. Hitung ΔH
                                    untuk
                            ...
                            <p>
                                ...
                                dihasilkan energi sebesar 5450 kJ/mol serta gas karbon dioksida dan uap air. Tuliskan
                                persamaan
                                termokimia
                                pembakarannya!
                            </p>
                    ...
                    <section id="jenis-perubahan-entalpi" class="mb-12">
                        ...
                        <article class="prose lg:prose-lg max-w-none">
                            <p>Perubahan entalpi reaksi yang diukur pada temperatur 25°C (298 K) dan tekanan 1 atm
                                disepakati
                                sebagai perubahan entalpi standar, dinyatakan dengan simbol ΔH⁰. Keadaan standar ini
                                diperlukan
                                karena pengukuran pada suhu dan tekanan yang berbeda akan menghasilkan harga perubahan
                                entalpi
                                yang berbeda pula. Satuan yang digunakan untuk menyatakan perubahan entalpi adalah kJ.
                                Perubahan
                            ...
                            <h3 class="text-xl font-bold text-white bg-orange-500 inline-block px-4 py-2 rounded">Entalpi
                                Perubahan Kimia</h3>
                            <p>Data entalpi perubahan kimia biasanya diberikan dalam keadaan standar. Entalpi standar
                                perubahan
                                kimia terdiri dari entalpi pembentukan standar, entalpi atomisasi standar, entalpi
                                pembakaran
                                standar, entalpi netralisasi standar, dan entalpi pelarutan standar.</p>

                            <h4 class="text-lg font-semibold mt-6">1. Entalpi penguraian standar
                                (ΔH<sub>d</sub><sup>o</sup>)
                            </h4>
                            <p>Perubahan entalpi penguraian standar (ΔH<sub>d</sub><sup>o</sup>) adalah kebalikan dari
                                perubahan
                                entalpi pembentukan standar (ΔH<sub>f</sub><sup>0</sup>), sehingga nilai
                                ΔH<sub>d</sub><sup>o</sup> = –ΔH<sub>f</sub><sup>0</sup>. Oleh karena itu reaksi penguraian
                                MgO
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg text-sm mt-4">
                                ...
                                <ul class="list-disc ml-6">
                                    <li>ΔH<sub>d</sub><sup>o</sup> adalah kebalikan dari ΔH<sub>f</sub><sup>0</sup>, jika
                                        hasil
                                ...
                                <p>NH<sub>3</sub> → ½ N<sub>2</sub>(g) + 3/2 H<sub>2</sub>(g) &nbsp;
                                    ΔH<sub>d</sub><sup>o</sup>
                                    = +46 kJ/mol</p>
                            </div>


                            <h4 class="text-lg font-semibold mt-6">2. Entalpi Pembakaran Standar
                                (ΔH<sub>c</sub><sup>o</sup>)
                            </h4>
                            <p>Entalpi pembakaran standar adalah kalor yang dibutuhkan dalam pembakaran sempurna 1 mol
                                senyawa
                            ...
                            <ol class="list-decimal ml-6">
                                ...
                                <li>senyawa hidrokarbon (C<sub>x</sub>H<sub>y</sub>) terbakar sempurna menurut reaksi: <br>
                                    C<sub>x</sub>H<sub>y</sub> + O<sub>2</sub> → CO<sub>2</sub> + H<sub>2</sub>O (belum
                                    setara)
                                </li>
                            </ol>
                            ...
                            <h4 class="text-lg font-semibold mt-6">3. Entalpi Pembakaran Standar
                                (ΔH<sub>c</sub><sup>0</sup>)
                            </h4>
                            <p>
                                Entalpi pembakaran standar adalah kalor yang dibutuhkan dalam pembakaran sempurna 1 mol
                                senyawa
                                atau unsur dengan oksigen (O<sub>2</sub>) dari udara, yang diukur pada keadaan standar.
                                ...
                                <table class="table-auto border text-sm w-full md:w-1/2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border px-2 py-1 bg-orange-100">ΔH<sup>c</sup><sup>0</sup> (kJ/mol)
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <p>
                                ...
                                (H<sup>+</sup>) oleh basa (OH<sup>−</sup>) membentuk 1 mol garam dan 1 mol air yang diukur
                                pada
                            ...
                            <table class="table-auto border text-sm my-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border px-3 py-1 bg-orange-100">ΔH<sub>neut</sub><sup>0</sup> (kJ/mol)
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <ol class="list-decimal ml-6 text-sm space-y-2">
                                <li>
                                    Mengidentifikasi jenis-jenis perubahan entalpi standar (ΔH<sup>0</sup>). Cermati
                                    beberapa
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        <td class="border px-2 py-1 text-left">3C<sub>2</sub>H<sub>5</sub>OH(l) +
                                            9O<sub>2</sub>(g) → 6CO<sub>2</sub>(g) + 9H<sub>2</sub>O(l) &nbsp;&nbsp;&nbsp;
                                            ΔH =
                                            -3.690 kJ</td>
                                        <td class="border px-2 py-1">.........</td>
                                        <td class="border px-2 py-1">.........</td>
                            ...
                            <p class="mt-6 text-sm">
                                ...
                                CH<sub>3</sub>Cl(g) → C(s) + 3/2 H<sub>2</sub>(g) + 1/2 Cl<sub>2</sub>(g) &nbsp;&nbsp;&nbsp;
                                ΔH
                    ...
                    <section id="penentuan-perubahan-entalpi" class="mb-12">
                        ...
                        <article class="prose lg:prose-lg max-w-none">
                            <p>Perubahan entalpi merupakan salah satu konsep penting dalam termokimia yang membantu kita
                                ...
                                sehari-hari, konsep ini berperan penting dalam berbagai proses seperti pembakaran,
                                metabolisme,
                                hingga dalam perancangan sistem energi.</p>

                            <p>Panas pembakaran ini dapat ditentukan melalui perhitungan perubahan entalpi. Perubahan
                                Entalpi
                            ...
                            <p>Alat yang digunakan adalah kalorimeter yaitu alat yang digunakan untuk mengukur perubahan
                                energi
                                termal atau perpindahan kalor. Perubahan kalor pada suatu reaksi dapat diukur melalui
                                pengukuran
                                perubahan suhu yang terjadi pada reaksi tersebut.</p>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                                <figure class="text-center">
                                    <img src="{{ asset('assets/images/materi/kaloriser.png') }}"
                                        alt="Kalorimeter Sederhana" class="rounded-lg shadow">
                            ...
                            <p>Kalorimeter adalah suatu sistem terisolasi (tidak ada perpindahan materi maupun energi dengan
                                lingkungan di luar kalorimeter). Secara garis besar, kalorimeter dibedakan menjadi dua,
                                yaitu
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
                                <p>Dalam kalorimeter yang telah dikalibrasi dan terbuka direaksikan 50g alkohol dan 3g logam
                                    natrium. Jika suhu awal campuran 30°C dan setelah reaksi suhunya 75°C, tentukan ΔH
                                    reaksi.
                                    Diketahui kalor jenis larutan 3,65 J g⁻¹°C⁻¹, kapasitas kalor kalorimeter 150 J °C⁻¹,
                                    dan
                                ...
                                <p class="mt-2">Jadi, reaksi alkohol dan logam natrium melepaskan kalor sebesar 10.205
                                    kJ.
                                    Oleh karena pada percobaan dilakukan pada tekanan tetap maka q reaksi = ΔH reaksi =
                                    –10.205
                                    kJ.</p>
                            </div>

                            <h4 class="mt-6 font-semibold">Latihan Soal:</h4>
                            <p>Sebanyak 1,28 g C₁₀H₈ (Mr = 128 mol⁻¹) dibakar dalam kalorimeter bom, akibat pembakaran
                                tersebut
                                suhu air berubah dari 20°C menjadi 25°C. Jika kapasitas kalor kalorimeter sebesar 10,17 kJ
                                °C⁻¹,
                    ...
                    <section id="berdasarkan-entalpi-pembentukan" class="mb-12">
                        <article class="prose lg:prose-lg max-w-none">
                            ...
                            <p>Kalor suatu reaksi dapat ditentukan berdasar data entalpi pembentukan zat pereaksi dan zat
                                produknya. Dalam hal ini, zat pereaksi dianggap terlebih dahulu terurai menjadi
                                unsur-unsurnya,
                            ...
                            <p>Entalpi pembentukan zat yang diukur pada keadaan standar merupakan harga ΔH<sub>f</sub>⁰,
                                oleh
                            ...
                            <p>aA + bB + ... → dD + eE + ... ΔH = ?</p>
                            <p>di mana a adalah koefisien reaktan A, b adalah koefisien reaktan B, d adalah koefisien produk
                                D,
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
                                ...
                                <p>= (1ΔH<sub>f</sub>⁰ CO₂ + 2ΔH<sub>f</sub>⁰ H₂O) – (ΔH<sub>f</sub>⁰ CH₃OH +
                                    3/2ΔH<sub>f</sub>⁰
                                    O₂)</p>
                                ...
                                <p class="mt-4">b. <strong>Tentukan</strong> jumlah kalor yang dibebaskan pada pembakaran
                                    8
                                    gram metanol!</p>
                            </div>
                        </article>
                    ...
                    <section id="berdasarkan-hukum-hess" class="mb-12">
                        <article class="prose lg:prose-lg max-w-none">
                            ...
                            <p>Menurut hukum Hess, karena entalpi adalah fungsi keadaan, perubahan entalpi dari suatu reaksi
                                ...
                                bukan langkah-langkah yang dilakukan untuk mencapainya. Jika suatu reaksi berlangsung dalam
                                dua
                                tahap atau lebih, maka perubahan entalpi reaksi tersebut sama dengan jumlah perubahan
                                entalpi
                            ...
                            <p>Hukum Hess dapat diilustrasikan melalui pembakaran nitrogen yang menghasilkan nitrogen
                                dioksida
                                seperti berikut ini.</p>
                            <p>N₂(g) + 2O₂(g) → 2NO₂(g) ΔH = +68 kJ/mol</p>

                            <p>Reaksi ini juga dapat dilakukan dalam dua langkah, dengan perubahan entalpi yang ditandai
                                dengan
                                ΔH₁ dan ΔH₂</p>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
                                ...
                                <ol class="list-decimal ml-6">
                                    ...
                                    <li>Koefisien reaksi (mol zat) yang diketahui harus sama dengan yang ditanyakan. Jika
                                        tidak
                                ...
                                <ul class="list-disc ml-6">
                                    ...
                                    <li>Persamaan (b) tidak perlu diubah sebab sudah sesuai dengan persamaan reaksi
                                        pembentukan
                                        asetilen (1 mol H₂)</li>
                                    <li>Persamaan (c) perlu dibalikkan arahnya, sebab C₂H₂ berada sebagai pereaksi.
                                        Persamaan
                    ...
                    <section id="berdasarkan-energi-ikatan" class="mb-12">
                        <article class="prose lg:prose-lg max-w-none">
                            ...
                            <p>Dalam suatu reaksi kimia, terjadi pemutusan ikatan pada reaktan terlebih dahulu. Kemudian
                                ...
                                dan
                                penggabungan ikatan kembali dari atom-atom yang terlibat reaksi sehingga membentuk susunan
                                baru
                                (proses yang membebaskan energi). Perubahan entalpi reaksi dapat dihitung dengan menggunakan
                                data energi ikatan. Energi ikatan adalah energi yang diperlukan untuk memutuskan 1 mol
                                ikatan
                                dalam fase gas zat kovalen untuk membentuk produk dalam fase gas pada suhu dan tekanan
                                konstan.
                            </p>
                            ...
                            <p>Ikatan antaratom Cl pada Cl₂ dan ikatan antaratom H pada H₂ harus putus terlebih dahulu.
                                Setelah
                                itu, H dan Cl membentuk ikatan baru sehingga terbentuk HCl. Nah, untuk memutuskan ikatan
                                diperlukan energi. Energi yang disebut energi ikatan. Perubahan entalpi (ΔH) suatu reaksi
                                dapat
